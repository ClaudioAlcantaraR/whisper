        ...
        <div className="p-6 flex space-x-2">
            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    <div>
                        <span className="text-gray-800">{whisper.user.name}</span>
                        <small className="ml-2 text-sm text-gray-600">{dayjs(whisper.created_at).fromNow()}</small>
                        { whisper.created_at !== whisper.updated_at && <small className="text-sm text-gray-600"> &middot; edited</small> }
                    </div>
                ...
                {editing 
                 ...
                 : (
                    <>
                        <p className="mt-4 text-lg text-gray-900">{whisper.message}</p>    
                    </>
                    ) 
                }
